...
public class Composite {
    ...
    public void generate_01(int num_segments, String shape){
        ...
        float element_center_x_1, element_center_x_2;
        float element_center_y_1, element_center_y_2;
        ...
        for (int i = 0 ; i < num_segments; i++){
            element_center_x_1 = center_x + (float)(Math.cos(i * angle)*radius_small);
            element_center_y_1 = center_y + (float)(Math.sin(i * angle)*radius_small);
            element_center_x_2 = center_x + (float)(Math.cos(i * angle)*radius_big);
            element_center_y_2 = center_y + (float)(Math.sin(i * angle)*radius_big);

            if(shape.equals("Kreis")){
                comp_container.add(new Kreis(element_center_x_1, element_center_y_1, element_radius_small, false));
                comp_container.add(new Kreis(element_center_x_2, element_center_y_2, element_radius_big, false));
            }
            else if(shape.equals("Quadrat")){
                comp_container.add(new Quadrat(element_center_x_1, element_center_y_1, element_radius_small, false));
                comp_container.add(new Quadrat(element_center_x_2, element_center_y_2, element_radius_big, false));
            }
        }
    ...
    public void generate_02(int num_segments, String shape){
        ...
        float element_center_x_1, element_center_x_2, element_center_x_3;
        float element_center_y_1, element_center_y_2, element_center_y_3;

        for(int i = 0; i < num_segments; i++){
            element_center_x_1 = center_x + (float)(Math.cos((i * angle))* radius_1);
            element_center_y_1 = center_y + (float)(Math.sin((i * angle))* radius_1);

            element_center_x_2 = center_x + (float)(Math.cos((i * angle))* radius_2);
            element_center_y_2 = center_y + (float)(Math.sin((i * angle))* radius_2);

            element_center_x_3 = center_x + (float)(Math.cos((i * angle))* radius_3);
            element_center_y_3 = center_y + (float)(Math.sin((i * angle))* radius_3);

            if(shape.equals("Kreis")){
                comp_container.add(new Kreis(element_center_x_1, element_center_y_1, element_radius_1, true));
                comp_container.add(new Kreis(element_center_x_2, element_center_y_2, element_radius_2, true));
                comp_container.add(new Kreis(element_center_x_3, element_center_y_3, element_radius_3, true));
            }
            else if(shape.equals("Quadrat")){
                comp_container.add(new Quadrat(element_center_x_1, element_center_y_1, element_radius_1, true));
                comp_container.add(new Quadrat(element_center_x_2, element_center_y_2, element_radius_2, true));
    ...
    public void generate_03(int num_segments, String shape){
        ...
        float element_center_x_1, element_center_x_2, element_center_x_3, element_center_x_4;
        float element_center_y_1, element_center_y_2, element_center_y_3, element_center_y_4;

        for(int i = 0; i < num_segments; i++){
            element_center_x_1 = center_x + (float)(Math.cos((i * angle))* radius_big);
            element_center_y_1 = center_y + (float)(Math.sin((i * angle))* radius_big);

            element_center_x_2 = center_x + (float)(Math.cos((i * angle))* (diameter/2 *0.9f));
            element_center_y_2 = center_y + (float)(Math.sin((i * angle))* (diameter/2 *0.9f));

            element_center_x_3 = center_x + (float)(Math.cos((i * angle))* (diameter/2 * 0.25f));
            element_center_y_3 = center_y + (float)(Math.sin((i * angle))* (diameter/2 * 0.25f));

            element_center_x_4 = center_x + (float)(Math.cos((i * angle))* (diameter/2 * 0.4f));
            element_center_y_4 = center_y + (float)(Math.sin((i * angle))* (diameter/2 * 0.4f));

            if(shape.equals("Kreis")){
                comp_container.add(new Kreis(element_center_x_1, element_center_y_1, element_radius_big, true));
                comp_container.add(new Kreis(element_center_x_2, element_center_y_2, element_radius_small, true));
                comp_container.add(new Kreis(element_center_x_3, element_center_y_3, element_radius_small, true));
                comp_container.add(new Kreis(element_center_x_4, element_center_y_4, element_radius_small, true));
            }
            else if(shape.equals("Quadrat")){
                comp_container.add(new Quadrat(element_center_x_1, element_center_y_1, element_radius_big, true));
                comp_container.add(new Quadrat(element_center_x_2, element_center_y_2, element_radius_small, true));
                comp_container.add(new Quadrat(element_center_x_3, element_center_y_3, element_radius_small, true));
                comp_container.add(new Quadrat(element_center_x_4, element_center_y_4, element_radius_small, true));
            }
    ...
    public void generate_21(int num_segments, String shape){
        if(shape.equals("Kreis")){
            ...
            comp_container.add(new Quadrat(center_x, center_y, diameter/2 * 0.075f, true));
        }
    }
    ...
    public void generate_22(int num_segments, String shape){
        if(shape.equals("Kreis")){
            ...
            comp_container.add(new Quadrat(center_x, center_y, diameter/2 * 0.075f, true));
            comp_container.add(new Quadrat(center_x, center_y, diameter/2 * 0.1f, true));
            comp_container.add(new Quadrat(center_x, center_y, diameter/2 * 0.125f, true));
        }
    }
